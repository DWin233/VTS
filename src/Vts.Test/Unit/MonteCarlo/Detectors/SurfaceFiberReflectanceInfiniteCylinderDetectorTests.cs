...
[TestFixture]
public class SurfaceFiberReflectanceInfiniteCylinderDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testsurfacefiberreflectanceinfinitecylinder");
    }
    ...
    {
        const string detectorName = "testsurfacefiberreflectanceinfinitecylinder";
        var detector = new SurfaceFiberReflectanceInfiniteCylinderDetector
        {
