...
[TestFixture]
public class SurfaceFiberTransmittanceInfiniteCylinderDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testsurfacefibertransmittanceinfinitecylinder");
    }
    ...
    {
        const string detectorName = "testsurfacefibertransmittanceinfinitecylinder";
