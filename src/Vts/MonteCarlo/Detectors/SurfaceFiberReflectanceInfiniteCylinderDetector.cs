...
{
    /// <summary>
    /// DetectorInput for an actual fiber detector on reflectance surface of
    /// MultiLayerInfiniteCylinder tissue
    /// </summary>
    public class SurfaceFiberReflectanceInfiniteCylinderDetectorInput : DetectorInput, IDetectorInput
    {
        /// <summary>
        ...
        /// </summary>
        public SurfaceFiberReflectanceInfiniteCylinderDetectorInput()
        {
            TallyType = "SurfaceFiberReflectanceInfiniteCylinder";
            Center = new Position(0, 0, 0);
            Radius = 0.6;
            N = 1.4;
            Name = "SurfaceFiberReflectanceInfiniteCylinder";
            NA = double.PositiveInfinity; // set default NA completely open regardless of detector region refractive index
            FinalTissueRegionIndex = 0; // assume detector is in surface fiber region

            // modify base class TallyDetails to take advantage of built-in validation capabilities (error-checking)
            TallyDetails.IsReflectanceInfiniteCylinderTally = true;
        ...
        {
            return new SurfaceFiberReflectanceInfiniteCylinderDetector
            {
    ...
    /// </summary>
    public class SurfaceFiberReflectanceInfiniteCylinderDetector : Detector, IDetector
    {
